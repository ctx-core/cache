...
export declare function cache$_<Val extends unknown = unknown, query_data_T extends unknown = unknown>(
	...
	cache$__opts?:cache$__opts_T<query_data_T>
):cache$_T<Val, query_data_T>;
export interface cache$__opts_T<query_data_T extends unknown = unknown> {
	id_?:(query_data:query_data_T)=>string;
	ttl?:number;
	period?:number;
	poll?:boolean;
}
export type cache_ctx$__opts_T = cache$__opts_T
export declare type cache$__query_T<Val extends unknown = unknown, query_data_T extends unknown = unknown> =
	(query_data:query_data_T, opts?:cache$__opts_T)=>Promise<Val>;
export interface cache$__be_opts_T extends cache$__opts_T {
	id?:string;
	ttl?:number;
	period?:number;
	poll?:boolean;
...
export type cache_ctx$__be_opts_T = cache$__be_opts_T
...
export interface cache$_T<Val extends unknown = unknown, query_data_T extends unknown = unknown> extends ReadableAtom$<cache_T<Val>> {
	be:(query_data:query_data_T, opts?:cache$__be_opts_T)=>cache_value$_T<Val>;
	ensure:(query_data:query_data_T, opts?:cache$__be_opts_T)=>Promise<cache_value$_T<Val>|nullish>;
	ensure_val:(query_data:query_data_T, opts?:cache$__be_opts_T)=>Promise<Val|nullish>;
