...
export interface cache__T<Key, Val, query_data_T> extends ReadableAtom_<cache_T<Key, Val>> {
	be:(query_data:query_data_T, params?:cache___be_params_T<Key, Val, query_data_T>)=>cache_value__T<Val>;
	ensure:(query_data:query_data_T, params?:cache___be_params_T<Key, Val, query_data_T>)=>Promise<cache_value__T<Val>>;
	ensure_val:(query_data:query_data_T, params?:cache___be_params_T<Key, Val, query_data_T>)=>Promise<Val>;
