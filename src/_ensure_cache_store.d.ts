...
export declare type ensure_cache_query_type</*@formatter:off*/ input_type extends unknown = unknown, query_ctx_type extends unknown = any> = (this: $cache_store_type<input_type>, query_ctx: query_ctx_type, id: string) => Promise<input_type>;
