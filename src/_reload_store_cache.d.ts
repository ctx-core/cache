...
export declare function _reload_store_cache</*@formatter:off*/ I extends unknown = unknown, S extends Writable<cache_type<I>> = Writable<cache_type<I>>>(store: S): reload_store_cache_type;
