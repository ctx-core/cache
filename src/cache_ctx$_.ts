...
>/*@formatter:on*/(
	...
	):Promise<cache_ctx$__value_T<$value_T>|undefined> {
		const cache_ctx_value = base_be(id)
		await load(id, opts)
		return cache_ctx_value
	}
	...
	function cache_ctx_value_():cache_ctx$__value_T<$value_T> {
		const cache_ctx_value = writable$<$value_T|undefined>(undefined)
		return assign(cache_ctx_value, {}) as cache_ctx$__value_T<$value_T>
	}
}
...
export interface cache_ctx$__value_T<$value_type extends unknown = unknown>
...
export type cache_ctx_value_type = cache_ctx$__value_T
export type cache_ctx_T<$value_type extends unknown = unknown> =
	Record<string, cache_ctx$__value_T<$value_type>>
...
export interface cache_ctx$_T<$value_type extends unknown = unknown, opts_data_type extends unknown = unknown>
	...
	be:(id:string, opts?:cache_ctx$__be_opts_T<opts_data_type>)=>cache_ctx$__value_T<$value_type>
	ensure:(id:string, opts?:cache_ctx$__be_opts_T<opts_data_type>)=>Promise<cache_ctx$__value_T<$value_type>>
}
