...
export declare function _cache_ctx</*@formatter:off*/ $value_type extends unknown = unknown, opts_data_type extends unknown = unknown>(query: cache_ctx_query_type<$value_type, cache_ctx_be_opts_type<opts_data_type>>, _cache_ctx_opts?: _cache_ctx_opts_type): cache_ctx_type<$value_type, opts_data_type>;
...
export interface cache_ctx_value_type<$value_type extends unknown = unknown> extends Writable<$value_type> {
...
export declare type $cache_ctx_type<$value_type extends unknown = unknown> = Record<string, cache_ctx_value_type<$value_type>>;
